...
cpdef tuple get_hilbert_basis_w_irreducibles_np(
    ...
    Start with a list of irreducibles.
    """
...
cpdef tuple get_hilbert_basis_hom_cone_np(
    cnp.ndarray[DTYPE_t, ndim=2] generators,
    cnp.ndarray[DTYPE_t, ndim=2] inequalities,
    int stop_at_height=-1,
):
    """
    Compute the Hilbert basis of the cone generated by the generators.
    Assumes that the point at height 1 are irreducibles.
    """
    ...
    return get_hilbert_basis_w_irreducibles_np(generators, irreducibles, inequalities, stop_at_height)